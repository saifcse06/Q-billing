...
<div class="form-group">
    {!! Html::decode(  Form::label('email','Email',['class'=>'col-lg-2 col-sm-2 control-label'])) !!}
    <div class="col-lg-10">
        <div class="iconic-input right">
...
<div class="form-group">
    ...
    <div class="col-lg-10">
        ...
        @if(isset($update_info))
        <img src="{{asset('project_files/profile_photo/'.$update_info->profile_picture)}}" height="100"  >
            @endif
    </div>
</div>
