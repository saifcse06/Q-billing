                ...
                <div class="panel-body">
                    <div class="content">
                        <div class="row">
                            ...
                            @if(Auth::user()->type=='Client')
                                <div class="col-md-3">
                                    {!! Form::select('type',['Active'=>'Active','Inactive'=>'Inactive'],null,['class'=>'form-control','placeholder'=>'Select Status']) !!}
                                </div>
                            @endif
                            <div class="col-md-3">
                    ...
                    @if (count($allbusinesstype) > 0)
                        <div class="table-responsive businesstype">
                            @include('backend.admin_client_business.table_load')
                        </div>
                    @else
...
@push('js')
    ...
    @include('backend.admin_client_business._script')
@endpush