                    ...
                    <div class="content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-md-offset-3">
                                {{ Form::text('name',null,['class'=>'form-control js-example-basic-single','placeholder'=>'Customer Group Name']) }}
                            </div>
                        ...
                        <br>
                        @if (count($allcustomergroup) > 0)
                            <div class="table-responsive businesstype">
                                @include('backend.customer_group.table_load')
                            </div>
                        @else
                            <h3 style="text-align: center">No Data Found<br>
                                <a href="{{route('customer_group.create')}}" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Create New</a>
                            </h3>
                        @endif
                    </div></div>
            </section>
