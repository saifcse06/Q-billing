            ...
            <td>
                <div class="btn-group">
                    ...
                    <ul role="menu" class="dropdown-menu float-right">
                        <li>
                            <a href="{{route("items_manage.edit",$v->id)}}" ><i class="fa fa-edit"></i> Edit</a></li>
...
<ul class="pagination pagination-lg pull-right">{{ $allItemsLists->links() }}</ul>