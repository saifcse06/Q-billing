            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <div class="content">
                        ...
                        <br>
                    @if (count($allItemsLists) > 0)
                        <div class="table-responsive businesstype">
                            @include('backend.items.table_load')
                        </div>
                    @else
                        <h3 style="text-align: center">No Data Found <br>
                            <a href="{{route('items_manage.create')}}" class="btn btn-primary pull-right"><i class="fa fa-plus-circle"></i> Create New</a>

                            <a href="{{url()->previous()}}" class="btn btn-warning pull-left"><i class="fa fa-arrow-left"></i> Back</a>
                        </h3>
                    @endif
                </div>
                </div>
