...
@section('content')
    <div class="row">
        <div class="col-sm-12">
            ...
            {!! Form::open(['route'=>'client.registration','class'=>'form-signin formwidth','enctype'=>"multipart/form-data",'id'=>'userform']) !!}
            <img src="{!! asset('img/logo.png') !!}" style="margin-top: 10px">
            <h2 class="form-signin-heading">registration  Payee Account</h2>
